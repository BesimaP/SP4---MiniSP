...
public class AppointmentController {
    ...
    public void handleSave(LocalDate date, String type, String location) {
        ...
        try {
            ...
            // Konverter aftaletypen til en gyldig EventType
            // SCANNING og BLOOD_TEST findes ikke i EventType — de gemmes som EXAMINATION
            // CONSULTATION, EGG_RETRIEVAL, TRANSFER og OTHER matcher direkte
            String eventType;
            if (type.equals("SCANNING") || type.equals("BLOOD_TEST")) {
